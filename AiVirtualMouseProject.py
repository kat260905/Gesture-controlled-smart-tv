...
#Screen resolution fetched using pyautogui to map the hand's coordinates to screen coordinates
...
while True:
    ...
    cv2.imshow("Image", img)
    key=cv2.waitKey(1)
    if key & 0xFF == ord('q'): #cv2.waitKey(1)- 1 ms
        break
